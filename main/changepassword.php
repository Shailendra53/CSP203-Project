      ...
      <div class="row">
        <div class="col-lg-8">
          ...
          <div class="contact_form">
            ...
            echo '
            <div class="contact_title">Enter details.</div>
                <div class="contact_form_container">
                  <form action="changepass.php" method="post">
                      
                      <div class="input-container">
                        <input type="text" name="password" required="*" class="input_field contact_form_name" placeholder="Current Password" style="color:black;">
                        <!-- <label for="#{label}">shopname</label> -->
                        <div class="bar"></div>
                      </div>
                      <div class="input-container">
                        <input type="text" name="newpass" required="*" class="input_field contact_form_name" placeholder="New Password" style="color:black;">
                        <!-- <label for="#{label}">shopname</label> -->
                        <div class="bar"></div>
                      </div>
                      <div class="container1 input-container" style="height: 0px;">
                        <font style="font-weight: 100;font-size: 30px;color: black">
                          <input type="radio" name="role" value="user" style="height: 10px;position: absolute;margin-left: 95%;top: 10px" required="*"> USER<br>
                          <input type="radio" name="role" value="shopkeeper" style="height: 10px;position: absolute;margin-left: 95%;top: 60px;" required="*"> SHOPKEEPER
                        </font>
                      </div>
                      <br><br><br><br><br>
                ...
                echo '<div class="contact_title">You don\'t have authentication to this page.</div>';
              }
